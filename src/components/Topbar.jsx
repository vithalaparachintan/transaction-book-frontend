...
export default function Topbar() {
  ...
  return (
    <header className={`shadow-md sticky top-0 z-50 border-b backdrop-blur-sm transition-colors duration-300 ${
      isDarkMode 
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8 py-4">
        ...
        <Link to="/" className="flex items-center gap-3 group">
          <div className="relative">
            ...
            <div className="relative bg-gradient-to-br from-cyan-500 to-cyan-700 rounded-xl p-2.5 text-white font-bold text-xl group-hover:scale-105 transition-transform shadow-lg">
              TB
            </div>
          </div>
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className={`md:hidden border-t shadow-lg animate-in slide-in-from-top-2 duration-200 ${
