  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="mx-auto h-16 w-16 flex items-center justify-center bg-gradient-to-br from-sky-500 to-cyan-500 rounded-xl text-white font-bold text-3xl shadow-lg">
          TB
        </div>
